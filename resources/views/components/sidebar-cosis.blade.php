<aside
    x-data="{ mini: (window.localStorage.getItem('laracosis_sidebar_mini') === 'true'), showTip: false, tipLabel: '', tipTop: 0, tipLeft: 0 }"
...
>
    ...
    <div class="px-4 py-3 border-t border-gray-100 dark:border-gray-800">
        <div class="text-xs text-gray-400 text-center mt-2">v1.0.0 – LaraCosis</div>
    </div>
    <button type="button"
        ...
        @click="
            mini = !mini;
            window.localStorage.setItem('laracosis_sidebar_mini', mini);
